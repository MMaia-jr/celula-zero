...
export function toPortableOperatingLoop(project: WorkbenchProject, exportedAt: string) {
  return {
    ...
    opportunities: project.opportunities.map((opportunity) => ({
      ...
      currentVersion: opportunity.currentVersion,
      materialVersion: opportunity.materialVersion,
    ...
    proposals: project.proposals.map((proposal) => ({
      ...
      materialVersion: proposal.materialVersion,
      statement: proposal.statement,
      conditions: proposal.conditions,
      expectedDelivery: proposal.expectedDelivery,
      rewardExpectation: proposal.rewardExpectation,
